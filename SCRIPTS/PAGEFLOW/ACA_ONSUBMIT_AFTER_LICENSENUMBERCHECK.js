...
var controlString = "ACA_ONSUBMIT_AFTER_LICENSENUMBERCHECK"; 	// Standard choice for control
...
if (currentUserID.indexOf("PUBLICUSER") == 0) { publicUserID = currentUserID; currentUserID = "ADMIN"; publicUser = true }  // ignore public users
