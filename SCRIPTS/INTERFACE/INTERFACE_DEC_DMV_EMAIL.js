/*------------------------------------------------------------------------------------------------------/
| Program : INTERFACE_DEC_DMV_EMAIL.js
| Event   : Interface
|
| Usage   :
|
...
var email_to= lookup("INTERFACE:CONFIGS","DEC_DMV_REPORT_EMAIL_TO").toString();
var email_from = lookup("INTERFACE:CONFIGS","DEC_DMV_REPORT_EMAIL_FROM").toString();
