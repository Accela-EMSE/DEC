/*------------------------------------------------------------------------------------------------------/
| Program : INTERFACE_DEC_ACH_EMAIL_ATTACHMENT_SCRIPT.js
| Event   : Interface
|
| Usage   : 
|			
...
email_to= lookup("INTERFACE:CONFIGS","DEC_ACH_EMAIL_ATTACHMENT_TO").toString();
email_from = lookup("INTERFACE:CONFIGS","DEC_ACH_EMAIL_ATTACHMENT_FROM").toString();
