/*------------------------------------------------------------------------------------------------------/
| Program : INTERFACE_DEC_DAILYSPLIT_EMAIL.js
| Event   : Interface
|
| Usage   :
|
...
var email_to= lookup("INTERFACE:CONFIGS","DEC_DAILYSPLIT_REPORT_EMAIL_TO").toString();
var email_from = lookup("INTERFACE:CONFIGS","DEC_DAILYSPLIT_REPORT_EMAIL_FROM").toString();
var res = aa.sendMail(email_from,email_to,"",emailSubject,emailBody);
