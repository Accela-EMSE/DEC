/*------------------------------------------------------------------------------------------------------/
| Program : INTERFACE_DEC_MAGAZINE_CDS_EMAIL_SERVICE.js
| Event   : Interface
|
| Usage   : 
|			
...
| Action# : N/A
|
| Notes   : This script is used to send email to CDS.
|
|
|
/------------------------------------------------------------------------------------------------------*/
...
var emailto= lookup("INTERFACE:CONFIGS","DEC_MAGAZINE_CDS_EMAIL_TO").toString();
