...
var variable0 = expression.getValue("REFCONTACTTPLTABLE::AGNT_TABLES::BANK INFORMATION::Zip");
...
for (var rowIndex = 0; rowIndex < totalRowCount; rowIndex++) {
    ...
    variable0 = expression.getValue(rowIndex, "REFCONTACTTPLTABLE::AGNT_TABLES::BANK INFORMATION::Zip");
